...
public class User {
    ...
    public User(Integer userid, String openid, String name, String avatar, String gender, String province, String city, String country, String identifytype, String phone, String email, String time, String collection, String join, String build, String share, Integer signdaynum, String grade) {
        this.userid = userid;
        this.openid = openid;
        this.name = name;
        this.avatar = avatar;
